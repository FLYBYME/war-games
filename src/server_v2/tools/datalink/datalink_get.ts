...
import { datalinkGetContract } from '../../../sdk_v2/contracts/index.js';
import { DatalinkComponent } from '../../../engine/components/Datalink.js';
import { isMatchHandle } from '../../services/MatchService.js';

export const datalink_get = defineTool(datalinkGetContract, async (input, ctx) => {
    ...
    return {
        ...
        latencyMs: datalink.latencyTicks * 100, // 10Hz tick = 100ms per tick
