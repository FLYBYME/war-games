...
import { orbitalUpdateContract } from '../../../sdk_v2/contracts/index.js';
import { OrbitalComponent } from '../../../engine/components/Orbital.js';
import { isMatchHandle } from '../../services/MatchService.js';

export const orbital_update_elements = defineTool(orbitalUpdateContract, async (input, ctx) => {
    ...
    if (input.semiMajorAxisKm !== undefined) orb.semiMajorAxisM = input.semiMajorAxisKm * 1000;
    if (input.inclinationDeg !== undefined) orb.inclinationDeg = input.inclinationDeg;
