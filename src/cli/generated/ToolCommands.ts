...
export function registerGeneratedCommands(program: Command, client: WarGamesClientV2) {
    ...
    const agent_create = agent.command('create').description(`Create a new AI agent with a specific system prompt and model.`).action(async (o) => {
        try { const res = await client.api.agent.create(ZodToCliMapper.parseOptions(o, Contracts.AgentCreateInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const agent_list = agent.command('list').description(`List all available agents.`).action(async (o) => {
        try { const res = await client.api.agent.list(ZodToCliMapper.parseOptions(o, Contracts.AgentListInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const agent_delete = agent.command('delete').description(`Delete an agent and all its associated threads and messages.`).action(async (o) => {
        try { const res = await client.api.agent.delete(ZodToCliMapper.parseOptions(o, Contracts.AgentDeleteInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const agent_seed = agent.command('seed').description(`Populate or update the agent registry with system prompts from the prompts folder.`).action(async (o) => {
        try { const res = await client.api.agent.seed(ZodToCliMapper.parseOptions(o, Contracts.AgentSeedInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const agent_thread_create = agent.command('thread_create').description(`Create a new conversation thread for an agent.`).action(async (o) => {
        try { const res = await client.api.agent.thread_create(ZodToCliMapper.parseOptions(o, Contracts.ThreadCreateInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const agent_thread_history = agent.command('thread_history').description(`Retrieve the message history for a specific thread.`).action(async (o) => {
        try { const res = await client.api.agent.thread_history(ZodToCliMapper.parseOptions(o, Contracts.ThreadHistoryInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const automation_list_events = automation.command('list_events').description(`List all scripted events defined in the scenario.`).action(async (o) => {
        try { const res = await client.api.automation.list_events(ZodToCliMapper.parseOptions(o, Contracts.AutomationListEventsInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const automation_trigger_event = automation.command('trigger_event').description(`Force-trigger a scenario event, bypassing conditions.`).action(async (o) => {
        try { const res = await client.api.automation.trigger_event(ZodToCliMapper.parseOptions(o, Contracts.AutomationTriggerEventInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const automation_get_results = automation.command('get_results').description(`Retrieve pass/fail results for scenario assertions.`).action(async (o) => {
        try { const res = await client.api.automation.get_results(ZodToCliMapper.parseOptions(o, Contracts.AutomationGetResultsInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const bug_list = bug.command('list').description(`Retrieve a list of all reported issues.`).action(async (o) => {
        try { const res = await client.api.bug.list(ZodToCliMapper.parseOptions(o, Contracts.BugListInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const bug_create = bug.command('create').description(`Report a new issue found in the simulation.`).action(async (o) => {
        try { const res = await client.api.bug.create(ZodToCliMapper.parseOptions(o, Contracts.BugCreateInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const bug_get = bug.command('get').description(`Retrieve detailed information for a specific issue.`).action(async (o) => {
        try { const res = await client.api.bug.get(ZodToCliMapper.parseOptions(o, Contracts.BugGetInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const bug_update = bug.command('update').description(`Modify an existing bug report (e.g., change status or severity).`).action(async (o) => {
        try { const res = await client.api.bug.update(ZodToCliMapper.parseOptions(o, Contracts.BugUpdateInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const bug_add_comment = bug.command('add_comment').description(`Add a new comment or update to an issue discussion.`).action(async (o) => {
        try { const res = await client.api.bug.add_comment(ZodToCliMapper.parseOptions(o, Contracts.BugAddCommentInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const combat_get = combat.command('get').description(`View current engagement targets, weapon status, and ammo counts.`).action(async (o) => {
        try { const res = await client.api.combat.get(ZodToCliMapper.parseOptions(o, Contracts.CombatGetInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const combat_fire = combat.command('fire').description(`Fire a weapon at a specific target.`).action(async (o) => {
        try { const res = await client.api.combat.fire(ZodToCliMapper.parseOptions(o, Contracts.CombatFireInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const combat_fire_salvo = combat.command('fire_salvo').description(`Execute a multi-weapon salvo.`).action(async (o) => {
        try { const res = await client.api.combat.fire_salvo(ZodToCliMapper.parseOptions(o, Contracts.CombatFireSalvoInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const combat_list_mounts = combat.command('list_mounts').description(`Inspect turret/launcher configurations.`).action(async (o) => {
        try { const res = await client.api.combat.list_mounts(ZodToCliMapper.parseOptions(o, Contracts.CombatListMountsInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const combat_get_wra = combat.command('get_wra').description(`Retrieve Weapon Release Authority settings.`).action(async (o) => {
        try { const res = await client.api.combat.get_wra(ZodToCliMapper.parseOptions(o, Contracts.CombatGetWRAInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const combat_update_wra = combat.command('update_wra').description(`Update automated engagement constraints.`).action(async (o) => {
        try { const res = await client.api.combat.update_wra(ZodToCliMapper.parseOptions(o, Contracts.CombatUpdateWRAInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const combat_update_roe = combat.command('update_roe').description(`Override unit-specific Rules of Engagement.`).action(async (o) => {
        try { const res = await client.api.combat.update_roe(ZodToCliMapper.parseOptions(o, Contracts.CombatUpdateROEInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const datalink_get = datalink.command('get').description(`View latency, queue depth, and current network membership.`).action(async (o) => {
        try { const res = await client.api.datalink.get(ZodToCliMapper.parseOptions(o, Contracts.DatalinkGetInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const datalink_update_network = datalink.command('update_network').description(`Move an entity to a different tactical network.`).action(async (o) => {
        try { const res = await client.api.datalink.update_network(ZodToCliMapper.parseOptions(o, Contracts.DatalinkUpdateNetworkInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const datalink_set_emissions = datalink.command('set_emissions').description(`Manage datalink emission levels for stealth operations.`).action(async (o) => {
        try { const res = await client.api.datalink.set_emissions(ZodToCliMapper.parseOptions(o, Contracts.DatalinkSetEmissionsInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const db_profile_list = db.command('profile_list').description(`List all available unit profiles.`).action(async (o) => {
        try { const res = await client.api.db.profile_list(ZodToCliMapper.parseOptions(o, Contracts.DBProfileListInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const db_profile_get = db.command('profile_get').description(`Retrieve the full specification for a unit type.`).action(async (o) => {
        try { const res = await client.api.db.profile_get(ZodToCliMapper.parseOptions(o, Contracts.DBProfileGetInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const db_profile_create = db.command('profile_create').description(`Add a new unit definition to the registry.`).action(async (o) => {
        try { const res = await client.api.db.profile_create(ZodToCliMapper.parseOptions(o, Contracts.DBProfileCreateInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const db_weapon_list = db.command('weapon_list').description(`List all modeled weapon systems.`).action(async (o) => {
        try { const res = await client.api.db.weapon_list(ZodToCliMapper.parseOptions(o, Contracts.DBWeaponListInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const db_weapon_get = db.command('weapon_get').description(`Fetch weapon performance envelopes and seeker specs.`).action(async (o) => {
        try { const res = await client.api.db.weapon_get(ZodToCliMapper.parseOptions(o, Contracts.DBWeaponGetInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const db_scenario_list = db.command('scenario_list').description(`List all stored scenario templates.`).action(async (o) => {
        try { const res = await client.api.db.scenario_list(ZodToCliMapper.parseOptions(o, Contracts.DBScenarioListInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const db_scenario_get = db.command('scenario_get').description(`Retrieve the full manifest for a specific scenario template.`).action(async (o) => {
        try { const res = await client.api.db.scenario_get(ZodToCliMapper.parseOptions(o, Contracts.DBScenarioGetInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const db_seed = db.command('seed').description(`Populate the SQLite registry with baseline simulation data.`).action(async (o) => {
        try { const res = await client.api.db.seed(ZodToCliMapper.parseOptions(o, Contracts.DBSeedInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const entity_list = entity.command('list').description(`List all entities in the match with optional filtering.`).action(async (o) => {
        try { const res = await client.api.entity.list(ZodToCliMapper.parseOptions(o, Contracts.EntityListInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const entity_get = entity.command('get').description(`Retrieve the full component state of a single entity.`).action(async (o) => {
        try { const res = await client.api.entity.get(ZodToCliMapper.parseOptions(o, Contracts.EntityGetInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const entity_create = entity.command('create').description(`Spawn a new entity into the simulation.`).action(async (o) => {
        try { const res = await client.api.entity.create(ZodToCliMapper.parseOptions(o, Contracts.EntityCreateInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const entity_delete = entity.command('delete').description(`Remove an entity from the simulation.`).action(async (o) => {
        try { const res = await client.api.entity.delete(ZodToCliMapper.parseOptions(o, Contracts.EntityDeleteInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const entity_get_status = entity.command('get_status').description(`Quick operational status check for an entity.`).action(async (o) => {
        try { const res = await client.api.entity.get_status(ZodToCliMapper.parseOptions(o, Contracts.EntityStatusInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const env_get = env.command('get').description(`Retrieve global environmental data (weather, ocean, time).`).action(async (o) => {
        try { const res = await client.api.env.get(ZodToCliMapper.parseOptions(o, Contracts.EnvGetInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const env_update = env.command('update').description(`Modify global environmental conditions.`).action(async (o) => {
        try { const res = await client.api.env.update(ZodToCliMapper.parseOptions(o, Contracts.EnvUpdateInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const env_sample_terrain = env.command('sample_terrain').description(`Query terrain elevation and atmospheric data at a coordinate.`).action(async (o) => {
        try { const res = await client.api.env.sample_terrain(ZodToCliMapper.parseOptions(o, Contracts.EnvSampleTerrainInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const env_sample_ocean = env.command('sample_ocean').description(`Retrieve localized Sound Speed Profile for sonar modeling.`).action(async (o) => {
        try { const res = await client.api.env.sample_ocean(ZodToCliMapper.parseOptions(o, Contracts.EnvSampleOceanInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const env_get_borders = env.command('get_borders').description(`Fetch geopolitical boundaries and restricted zones.`).action(async (o) => {
        try { const res = await client.api.env.get_borders(ZodToCliMapper.parseOptions(o, Contracts.EnvGetBordersInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const env_set_time = env.command('set_time').description(`Set simulation time of day (affects visual/IR sensors).`).action(async (o) => {
        try { const res = await client.api.env.set_time(ZodToCliMapper.parseOptions(o, Contracts.EnvSetTimeInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const env_prefetch_terrain = env.command('prefetch_terrain').description(`Command workers to cache terrain tiles for a bounding box.`).action(async (o) => {
        try { const res = await client.api.env.prefetch_terrain(ZodToCliMapper.parseOptions(o, Contracts.EnvPrefetchTerrainInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const env_get_cache_stats = env.command('get_cache_stats').description(`Monitor disk/RAM usage of processed terrain tiles.`).action(async (o) => {
        try { const res = await client.api.env.get_cache_stats(ZodToCliMapper.parseOptions(o, Contracts.EnvGetCacheStatsInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const ew_get_jammer = ew.command('get_jammer').description(`Fetch current jammer power, frequency, and beam settings.`).action(async (o) => {
        try { const res = await client.api.ew.get_jammer(ZodToCliMapper.parseOptions(o, Contracts.EWGetJammerInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const ew_set_jammer_state = ew.command('set_jammer_state').description(`Toggle jammer active state, mode, or type.`).action(async (o) => {
        try { const res = await client.api.ew.set_jammer_state(ZodToCliMapper.parseOptions(o, Contracts.EWSetJammerStateInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const ew_assign_jammer_target = ew.command('assign_jammer_target').description(`Point a directional jammer at a specific target.`).action(async (o) => {
        try { const res = await client.api.ew.assign_jammer_target(ZodToCliMapper.parseOptions(o, Contracts.EWAssignJammerTargetInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const ew_get_sigint = ew.command('get_sigint').description(`Retrieve SIGINT data (localized jammer/emitter detections).`).action(async (o) => {
        try { const res = await client.api.ew.get_sigint(ZodToCliMapper.parseOptions(o, Contracts.EWGetSIGINTInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const group_list = group.command('list').description(`List all tactical groups in the match.`).action(async (o) => {
        try { const res = await client.api.group.list(ZodToCliMapper.parseOptions(o, Contracts.GroupListInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const group_get = group.command('get').description(`Get details of a specific tactical group.`).action(async (o) => {
        try { const res = await client.api.group.get(ZodToCliMapper.parseOptions(o, Contracts.GroupGetInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const group_create = group.command('create').description(`Create a new tactical group.`).action(async (o) => {
        try { const res = await client.api.group.create(ZodToCliMapper.parseOptions(o, Contracts.GroupCreateInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const group_set_leader = group.command('set_leader').description(`Reassign the group leader.`).action(async (o) => {
        try { const res = await client.api.group.set_leader(ZodToCliMapper.parseOptions(o, Contracts.GroupSetLeaderInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const group_set_parameters = group.command('set_parameters').description(`Adjust group formation and spacing.`).action(async (o) => {
        try { const res = await client.api.group.set_parameters(ZodToCliMapper.parseOptions(o, Contracts.GroupSetParametersInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const guidance_get = guidance.command('get').description(`Inspect lock-on status, seeker type, and current track.`).action(async (o) => {
        try { const res = await client.api.guidance.get(ZodToCliMapper.parseOptions(o, Contracts.GuidanceGetInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const guidance_update = guidance.command('update').description(`Adjust seeker sensitivity or maneuverability.`).action(async (o) => {
        try { const res = await client.api.guidance.update(ZodToCliMapper.parseOptions(o, Contracts.GuidanceUpdateInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const guidance_set_target = guidance.command('set_target').description(`Override the seeker's target for mid-course guidance.`).action(async (o) => {
        try { const res = await client.api.guidance.set_target(ZodToCliMapper.parseOptions(o, Contracts.GuidanceSetTargetInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const history_list_telemetry = history.command('list_telemetry').description(`Fetch time-series position and state data for a unit.`).action(async (o) => {
        try { const res = await client.api.history.list_telemetry(ZodToCliMapper.parseOptions(o, Contracts.HistoryListTelemetryInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const history_get_heatmap = history.command('get_heatmap').description(`Generate spatial density maps from telemetry data.`).action(async (o) => {
        try { const res = await client.api.history.get_heatmap(ZodToCliMapper.parseOptions(o, Contracts.HistoryGetHeatmapInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const history_list_events = history.command('list_events').description(`List all discrete simulation events for a batch.`).action(async (o) => {
        try { const res = await client.api.history.list_events(ZodToCliMapper.parseOptions(o, Contracts.HistoryListEventsInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const history_get_losses = history.command('get_losses').description(`Calculate attrition rates and loss-exchange ratios.`).action(async (o) => {
        try { const res = await client.api.history.get_losses(ZodToCliMapper.parseOptions(o, Contracts.HistoryGetLossesInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const history_aggregate_metrics = history.command('aggregate_metrics').description(`Compute statistical KPIs across simulation runs.`).action(async (o) => {
        try { const res = await client.api.history.aggregate_metrics(ZodToCliMapper.parseOptions(o, Contracts.HistoryAggregateMetricsInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const history_get_entity_samples = history.command('get_entity_samples').description(`Fetch detailed state samples for an entity over its lifetime.`).action(async (o) => {
        try { const res = await client.api.history.get_entity_samples(ZodToCliMapper.parseOptions(o, Contracts.HistoryGetEntitySamplesInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const kinematics_get = kinematics.command('get').description(`Retrieve high-fidelity position, velocity, and orientation data.`).action(async (o) => {
        try { const res = await client.api.kinematics.get(ZodToCliMapper.parseOptions(o, Contracts.KinematicsGetInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const kinematics_update = kinematics.command('update').description(`Adjust velocity or heading vectors directly.`).action(async (o) => {
        try { const res = await client.api.kinematics.update(ZodToCliMapper.parseOptions(o, Contracts.KinematicsUpdateInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const kinematics_set_position = kinematics.command('set_position').description(`Teleport a unit to a new coordinate.`).action(async (o) => {
        try { const res = await client.api.kinematics.set_position(ZodToCliMapper.parseOptions(o, Contracts.KinematicsSetPositionInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const kinematics_apply_force = kinematics.command('apply_force').description(`Apply an impulse force to a unit, bypassing propulsion.`).action(async (o) => {
        try { const res = await client.api.kinematics.apply_force(ZodToCliMapper.parseOptions(o, Contracts.KinematicsApplyForceInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const logistics_get = logistics.command('get').description(`Check fuel, ammo, and structural integrity.`).action(async (o) => {
        try { const res = await client.api.logistics.get(ZodToCliMapper.parseOptions(o, Contracts.LogisticsGetInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const logistics_update_state = logistics.command('update_state').description(`Manually set fuel or health levels.`).action(async (o) => {
        try { const res = await client.api.logistics.update_state(ZodToCliMapper.parseOptions(o, Contracts.LogisticsUpdateStateInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const logistics_transfer = logistics.command('transfer').description(`Transfer fuel between two entities.`).action(async (o) => {
        try { const res = await client.api.logistics.transfer(ZodToCliMapper.parseOptions(o, Contracts.LogisticsTransferInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const logistics_apply_damage = logistics.command('apply_damage').description(`Apply damage to a unit.`).action(async (o) => {
        try { const res = await client.api.logistics.apply_damage(ZodToCliMapper.parseOptions(o, Contracts.LogisticsApplyDamageInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const logistics_land = logistics.command('land').description(`Initiate a recovery sequence at a facility.`).action(async (o) => {
        try { const res = await client.api.logistics.land(ZodToCliMapper.parseOptions(o, Contracts.LogisticsLandInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const logistics_launch = logistics.command('launch').description(`Launch a stored unit from its parent platform.`).action(async (o) => {
        try { const res = await client.api.logistics.launch(ZodToCliMapper.parseOptions(o, Contracts.LogisticsLaunchInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const map_list_regions = map.command('list_regions').description(`List all pre-defined geographic theaters.`).action(async (o) => {
        try { const res = await client.api.map.list_regions(ZodToCliMapper.parseOptions(o, Contracts.MapListRegionsInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const map_get_overlay = map.command('get_overlay').description(`Fetch GeoJSON data for a map layer.`).action(async (o) => {
        try { const res = await client.api.map.get_overlay(ZodToCliMapper.parseOptions(o, Contracts.MapGetOverlayInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const map_get_los = map.command('get_los').description(`Calculate Line-of-Sight between two coordinates.`).action(async (o) => {
        try { const res = await client.api.map.get_los(ZodToCliMapper.parseOptions(o, Contracts.MapGetLOSInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const map_calculate_distance = map.command('calculate_distance').description(`Compute geodesic distance and bearing between two points.`).action(async (o) => {
        try { const res = await client.api.map.calculate_distance(ZodToCliMapper.parseOptions(o, Contracts.MapCalculateDistanceInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const map_list_zones = map.command('list_zones').description(`List active tactical zones (NFZ, WEZ, etc.).`).action(async (o) => {
        try { const res = await client.api.map.list_zones(ZodToCliMapper.parseOptions(o, Contracts.MapListZonesInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const map_update_zone = map.command('update_zone').description(`Dynamically update a tactical zone.`).action(async (o) => {
        try { const res = await client.api.map.update_zone(ZodToCliMapper.parseOptions(o, Contracts.MapUpdateZoneInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const map_create_zone = map.command('create_zone').description(`Create a new tactical zone.`).action(async (o) => {
        try { const res = await client.api.map.create_zone(ZodToCliMapper.parseOptions(o, Contracts.MapCreateZoneInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const map_get_elevation_profile = map.command('get_elevation_profile').description(`Returns a sample array of elevation points between two coordinates.`).action(async (o) => {
        try { const res = await client.api.map.get_elevation_profile(ZodToCliMapper.parseOptions(o, Contracts.MapGetElevationProfileInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const map_convert = map.command('convert').description(`Utility to convert between Geodetic (LLA), ECEF, and Local Tangent Plane (ENU).`).action(async (o) => {
        try { const res = await client.api.map.convert(ZodToCliMapper.parseOptions(o, Contracts.MapConvertCoordinatesInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const match_list = match.command('list').description(`Retrieve a paginated list of matches with optional filtering.`).action(async (o) => {
        try { const res = await client.api.match.list(ZodToCliMapper.parseOptions(o, Contracts.MatchListInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const match_create = match.command('create').description(`Create a new simulation match from a scenario template.`).action(async (o) => {
        try { const res = await client.api.match.create(ZodToCliMapper.parseOptions(o, Contracts.MatchCreateInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const match_get = match.command('get').description(`Retrieve the metadata and current status of a specific match.`).action(async (o) => {
        try { const res = await client.api.match.get(ZodToCliMapper.parseOptions(o, Contracts.MatchGetInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const match_update = match.command('update').description(`Update match operational parameters.`).action(async (o) => {
        try { const res = await client.api.match.update(ZodToCliMapper.parseOptions(o, Contracts.MatchUpdateInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const match_delete = match.command('delete').description(`Terminate and purge an active match.`).action(async (o) => {
        try { const res = await client.api.match.delete(ZodToCliMapper.parseOptions(o, Contracts.MatchDeleteInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const match_get_win_state = match.command('get_win_state').description(`Evaluate victory conditions for the current match state.`).action(async (o) => {
        try { const res = await client.api.match.get_win_state(ZodToCliMapper.parseOptions(o, Contracts.MatchWinStateInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const ministry_get_evaluation = ministry.command('get_evaluation').description(`Retrieve the DesiredState generated by an AI Ministry.`).action(async (o) => {
        try { const res = await client.api.ministry.get_evaluation(ZodToCliMapper.parseOptions(o, Contracts.MinistryGetEvaluationInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const ministry_update_doctrine = ministry.command('update_doctrine').description(`Inject doctrine parameters to change Ministry behavior.`).action(async (o) => {
        try { const res = await client.api.ministry.update_doctrine(ZodToCliMapper.parseOptions(o, Contracts.MinistryUpdateDoctrineInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const mission_list = mission.command('list').description(`List all active and queued missions for a unit.`).action(async (o) => {
        try { const res = await client.api.mission.list(ZodToCliMapper.parseOptions(o, Contracts.MissionListInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const mission_create = mission.command('create').description(`Assign a new mission to a unit.`).action(async (o) => {
        try { const res = await client.api.mission.create(ZodToCliMapper.parseOptions(o, Contracts.MissionCreateInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const mission_get_tasks = mission.command('get_tasks').description(`Inspect low-level tasks generated by the mission system.`).action(async (o) => {
        try { const res = await client.api.mission.get_tasks(ZodToCliMapper.parseOptions(o, Contracts.MissionGetTasksInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const nav_get = nav.command('get').description(`Check current destination, course, and autopilot mode.`).action(async (o) => {
        try { const res = await client.api.nav.get(ZodToCliMapper.parseOptions(o, Contracts.NavGetInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const nav_update = nav.command('update').description(`Adjust cruise speed, altitude, or heading.`).action(async (o) => {
        try { const res = await client.api.nav.update(ZodToCliMapper.parseOptions(o, Contracts.NavUpdateInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const nav_list_waypoints = nav.command('list_waypoints').description(`Retrieve the active flight plan or route.`).action(async (o) => {
        try { const res = await client.api.nav.list_waypoints(ZodToCliMapper.parseOptions(o, Contracts.NavListWaypointsInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const nav_add_waypoint = nav.command('add_waypoint').description(`Append a waypoint to the navigation path.`).action(async (o) => {
        try { const res = await client.api.nav.add_waypoint(ZodToCliMapper.parseOptions(o, Contracts.NavAddWaypointInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const nav_clear_waypoints = nav.command('clear_waypoints').description(`Clear all waypoints and stop navigation.`).action(async (o) => {
        try { const res = await client.api.nav.clear_waypoints(ZodToCliMapper.parseOptions(o, Contracts.NavClearWaypointsInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const nav_join_formation = nav.command('join_formation').description(`Attach unit to a leader for collective movement.`).action(async (o) => {
        try { const res = await client.api.nav.join_formation(ZodToCliMapper.parseOptions(o, Contracts.NavJoinFormationInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const nav_break_formation = nav.command('break_formation').description(`Detach unit from formation.`).action(async (o) => {
        try { const res = await client.api.nav.break_formation(ZodToCliMapper.parseOptions(o, Contracts.NavBreakFormationInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const orbital_get_elements = orbital.command('get_elements').description(`Fetch the Keplerian orbital elements for a satellite.`).action(async (o) => {
        try { const res = await client.api.orbital.get_elements(ZodToCliMapper.parseOptions(o, Contracts.OrbitalGetInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const orbital_update_elements = orbital.command('update_elements').description(`Manually adjust a satellite's orbit (Station Keeping).`).action(async (o) => {
        try { const res = await client.api.orbital.update_elements(ZodToCliMapper.parseOptions(o, Contracts.OrbitalUpdateInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const orbital_predict_pass = orbital.command('predict_pass').description(`Predict when a satellite will have LOS over a specific region.`).action(async (o) => {
        try { const res = await client.api.orbital.predict_pass(ZodToCliMapper.parseOptions(o, Contracts.OrbitalPredictInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const propulsion_get = propulsion.command('get').description(`Fetch real-time throttle, thrust, and engine state.`).action(async (o) => {
        try { const res = await client.api.propulsion.get(ZodToCliMapper.parseOptions(o, Contracts.PropulsionGetInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const propulsion_update = propulsion.command('update').description(`Adjust throttle or toggle afterburners.`).action(async (o) => {
        try { const res = await client.api.propulsion.update(ZodToCliMapper.parseOptions(o, Contracts.PropulsionUpdateInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const propulsion_set_state = propulsion.command('set_state').description(`Command engine startup, shutdown, or emergency cutoff.`).action(async (o) => {
        try { const res = await client.api.propulsion.set_state(ZodToCliMapper.parseOptions(o, Contracts.PropulsionSetStateInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const qa_test_weapon = qa.command('test_weapon').description(`Automated weapon testing with AI diagnostic analysis.`).action(async (o) => {
        try { const res = await client.api.qa.test_weapon(ZodToCliMapper.parseOptions(o, Contracts.TestWeaponInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const sensor_list = sensor.command('list').description(`List all onboard sensors and their settings.`).action(async (o) => {
        try { const res = await client.api.sensor.list(ZodToCliMapper.parseOptions(o, Contracts.SensorListInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const sensor_update = sensor.command('update').description(`Modify sensor properties like mode or power state.`).action(async (o) => {
        try { const res = await client.api.sensor.update(ZodToCliMapper.parseOptions(o, Contracts.SensorUpdateInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const sensor_set_emcon = sensor.command('set_emcon').description(`Set Emission Control level for the platform.`).action(async (o) => {
        try { const res = await client.api.sensor.set_emcon(ZodToCliMapper.parseOptions(o, Contracts.SensorSetEmconInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const sensor_add_detection = sensor.command('add_detection').description(`Grant a perfect detection of a target to an entity. Used for testing and munitions.`).action(async (o) => {
        try { const res = await client.api.sensor.add_detection(ZodToCliMapper.parseOptions(o, Contracts.SensorAddDetectionInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const side_get_roe = side.command('get_roe').description(`Retrieve the current ROE and EMCON for a side.`).action(async (o) => {
        try { const res = await client.api.side.get_roe(ZodToCliMapper.parseOptions(o, Contracts.SideGetROEInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const side_update_roe = side.command('update_roe').description(`Update side-wide Rules of Engagement.`).action(async (o) => {
        try { const res = await client.api.side.update_roe(ZodToCliMapper.parseOptions(o, Contracts.SideUpdateROEInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const signature_get = signature.command('get').description(`Fetch RCS, IR, and acoustic signatures.`).action(async (o) => {
        try { const res = await client.api.signature.get(ZodToCliMapper.parseOptions(o, Contracts.SignatureGetInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const signature_update = signature.command('update').description(`Apply signature modifiers (e.g., stealth configuration).`).action(async (o) => {
        try { const res = await client.api.signature.update(ZodToCliMapper.parseOptions(o, Contracts.SignatureUpdateInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const cm_deploy = cm.command('deploy').description(`Deploy chaff, flares, or acoustic decoys.`).action(async (o) => {
        try { const res = await client.api.cm.deploy(ZodToCliMapper.parseOptions(o, Contracts.CMDeployInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const cm_get_inventory = cm.command('get_inventory').description(`Check remaining countermeasure expendables.`).action(async (o) => {
        try { const res = await client.api.cm.get_inventory(ZodToCliMapper.parseOptions(o, Contracts.CMGetInventoryInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const sim_get = sim.command('get').description(`Get the current simulation status including tick, speed, and pause state.`).action(async (o) => {
        try { const res = await client.api.sim.get(ZodToCliMapper.parseOptions(o, Contracts.SimGetInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const sim_step = sim.command('step').description(`Manually advance the simulation by one or more ticks.`).action(async (o) => {
        try { const res = await client.api.sim.step(ZodToCliMapper.parseOptions(o, Contracts.SimStepInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const sim_update = sim.command('update').description(`Adjust simulation speed or toggle pause state.`).action(async (o) => {
        try { const res = await client.api.sim.update(ZodToCliMapper.parseOptions(o, Contracts.SimUpdateInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const sim_get_metrics = sim.command('get_metrics').description(`Get real-time performance and memory metrics for the simulation server.`).action(async (o) => {
        try { const res = await client.api.sim.get_metrics(ZodToCliMapper.parseOptions(o, Contracts.SimGetMetricsInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const track_list = track.command('list').description(`Retrieve all tracks known to a specific side.`).action(async (o) => {
        try { const res = await client.api.track.list(ZodToCliMapper.parseOptions(o, Contracts.TrackListInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const track_get = track.command('get').description(`Get detailed classification and position for a track.`).action(async (o) => {
        try { const res = await client.api.track.get(ZodToCliMapper.parseOptions(o, Contracts.TrackGetInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const track_update = track.command('update').description(`Update track classification or identification.`).action(async (o) => {
        try { const res = await client.api.track.update(ZodToCliMapper.parseOptions(o, Contracts.TrackUpdateInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const track_delete = track.command('delete').description(`Remove a track from the operational picture.`).action(async (o) => {
        try { const res = await client.api.track.delete(ZodToCliMapper.parseOptions(o, Contracts.TrackDeleteInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const worker_list = worker.command('list').description(`List all active worker pools and their high-level status.`).action(async (o) => {
        try { const res = await client.api.worker.list(ZodToCliMapper.parseOptions(o, Contracts.WorkerListInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
    ...
    const worker_get_stats = worker.command('get_stats').description(`Get detailed performance metrics for a specific worker pool.`).action(async (o) => {
        try { const res = await client.api.worker.get_stats(ZodToCliMapper.parseOptions(o, Contracts.WorkerGetStatsInputSchema as any)); console.log(JSON.stringify(res, null, 2)); } catch (err: any) { console.error(`\n${C.red}${C.bold}✖ Error:${C.reset} ${err.message}`); process.exit(1); }
    });
